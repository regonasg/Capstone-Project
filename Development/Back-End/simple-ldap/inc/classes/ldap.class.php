...
/*	
 *	Created by Web Services (jenkshaw) 09 Dec 2013
 *		-- creates a basic LDAP connection to the U of R Pool 
 *		-- Authentication based on tree 'all.uofr'
 *		-- Construct 
 *			- $server	- (optional) requires full server path, including protocol (ldaps://)
 *			- $port		- (optional) default of 636 set in object
 *	
 */	
...
class ldapUR {
	...
	public function __construct($server='ldaps://ldappool.cc.uregina.ca', $port=636) {
