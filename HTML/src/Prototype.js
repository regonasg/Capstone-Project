    ...
    render() {
        ...
        return (
            <div>
                ...
                <SemesterTable onSemesterTableUpdate={this.handleSemesterTable.bind(this)}
...
class SemesterTable extends React.Component {
    ...
    render() {
        ...
        var semester = this.props.semesters.map(function (semester) {
            ...
            return (<SemesterRow
                onSemesterTableUpdate={onSemesterTableUpdate}
                semester={semester} onDelEvent={rowDel.bind(this)}
                key={semester.id} />)
        });
        return (
            <div>
